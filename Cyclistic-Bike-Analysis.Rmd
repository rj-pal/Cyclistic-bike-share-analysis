...
First, I'd like to comment that I will take a unique approach in this report. Since the actual interaction between stakeholders is limited to the information as stated in the Google Data Analytics [Capstone Case Study Cours](https://www.coursera.org/learn/google-data-analytics-capstone?specialization=google-data-analytics), I am limited in my ability to ask direct questions to the stakeholders for clarification on the purpose of the analysis as well as about the data. I had some questions about the ficticious bike company Cyclistic and the data, which is based on the bike share system in the city of Chicago.
...
[In addition to marketing to day pass users, there would be much potential in marketing to users
I think it is best to marker to those riders who fit into the above profiles.]
...
2. What percentage of users ride over 30 mins / 45 mins / 3 hours? When do riders tend to take longer trips?
...
Even so, the **total number** of trips **over 45 mins** are on a **much smaller magnitude** when compared to trips **under 45 mins**. For example, looking at the chart above and below, a **30-minute** ride span of **15 to 45 mins** includes around **3M** trips while **the next 30-minute** ride span (45 to 75 mins) has just over **400K**. That is around a **90% drop** in ride numbers. And, the number of rides in the first group, **only a 15-minute ride length**, includes close to **5M** rides. The only conclusion is that most riders use the bike share system for shorter trips.
